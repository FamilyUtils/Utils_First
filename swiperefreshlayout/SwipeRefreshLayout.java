...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private static final int REFRESH_TRIGGER_DISTANCE = 50;
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        SwipeRefreshLayoutDirection direction
                ...
                .getFromInt(a2.getInt(R.styleable.SwipeRefreshLayout_direction, 0));
...
//    }
            ...
            if (mTarget instanceof AbsListView) {
                ...
                try {
                    if (absListView.getCount() > 0) {
                        if (absListView.getLastVisiblePosition() + 1 == absListView.getCount()) {
                            int lastIndex = absListView.getLastVisiblePosition() - absListView
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (mDirection) {
            case BOTTOM:
                if (!isEnabled() || mReturningToStart || (!mBothDirection && canChildScrollDown())
                        || mRefreshing) {
            ...
            case TOP:
            default:
                if (!isEnabled() || mReturningToStart || (!mBothDirection && canChildScrollUp())
                        || mRefreshing) {
                    // Fail fast if we're not in a state where a swipe is possible
                    return false;
                }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        try {
            ...
            Log.e(TAG,
                    "An exception occured during SwipeRefreshLayout onTouchEvent " + e.toString());
        }
